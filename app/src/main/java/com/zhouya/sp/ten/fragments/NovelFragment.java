 ...
 */
public class NovelFragment extends Fragment implements ViewPager.OnPageChangeListener {
    //请求article
    private static final String ARTICLE_URL = "http://api.shigeten.net/api/Novel/GetNovelList";
...
//    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View ret = inflater.inflate(R.layout.fragment_novel, container, false);

        mViewPager = (ViewPager) ret.findViewById(R.id.novel_view_pager);
...
//        setTitleTime(0);
                ...
                try {
                    ...
                    if(length > 0){
                        for (int i = 0; i < length; i++) {
                            JSONObject novel = results.getJSONObject(i);
                            int id = novel.getInt("id");
                            mBundle = new Bundle();
    ...
    private void setTitleTime(int value){
        ...
        switch (week) {
            case 1:
                imageWeek.setImageResource(R.mipmap.week_1);
                break;
            case 2:imageWeek.setImageResource(R.mipmap.week_2);
                break;
            case 3:imageWeek.setImageResource(R.mipmap.week_3);
                break;
            case 4:imageWeek.setImageResource(R.mipmap.week_4);
                break;
            case 5:imageWeek.setImageResource(R.mipmap.week_5);
                break;
            case 6:imageWeek.setImageResource(R.mipmap.week_6);
                break;
            case 7:imageWeek.setImageResource(R.mipmap.week_7);
                break;
